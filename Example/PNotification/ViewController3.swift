...
class ViewController3: UIViewController {
    ...
    @IBAction func buttonRegisterClicked(_ sender: Any) {
        _ = PNotificationCenter.defaultCenter.addObserverGuardAgainstReObserving(notificationName:"experiment.notification", observer: self, selector:#selector(ViewController3.notificationReceived(notification:)))
        updateObservingStatus()
    }
